...
class SnappingItemLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var margin = EdgeInsets.only(
      ...
      right: edgeMargin
          ? itemMargin
          : (index < itemCount - 1 ? itemMargin : 0),
      top: verticalMargin,
    ...
    return Container(
      ...
      decoration: isBlank
          ...
          : BoxDecoration(
              ...
              border:
                  itemBorder != null ? itemBorder(index) : null,
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => _shouldEnableToPressOnItem(index)
            ? Bounce(
                onPressed: () => widget.onItemPressed(index),
...
class SnapScrollPhysics extends ScrollPhysics {
  ...
  SnapScrollPhysics({this.itemDimension, ScrollPhysics parent})
      : super(parent: parent);
